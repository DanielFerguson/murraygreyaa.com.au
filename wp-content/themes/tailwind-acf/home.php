			...
			<section class="mb-16 rounded-3xl bg-white p-8 shadow-lg shadow-slate-200/60 sm:p-12">
				...
				<div class="grid gap-8 lg:grid-cols-[1.3fr_1fr] lg:items-center">
					<div class="space-y-6">
						...
						<div>
							<a class="inline-flex items-center gap-2 rounded-full bg-brand px-6 py-3 text-sm font-semibold text-white transition hover:bg-brand-dark" href="<?php echo esc_url( $permalink ); ?>">
