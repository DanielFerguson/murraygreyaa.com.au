	...
	function () {
		...
		acf_register_block_type(
			array(
				...
				'render_template' => get_theme_file_path( 'template-parts/blocks/photo-carousel.php' ),
				'category'        => 'media',
				'icon'            => 'images-alt2',
		...
		acf_register_block_type(
			array(
				...
				'render_template' => get_theme_file_path( 'template-parts/blocks/breed-highlight.php' ),
				'category'        => 'layout',
				'icon'            => 'awards',
